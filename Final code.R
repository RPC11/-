...
FeaturePlot(immune.combined,reduction="tsne", features = c("CD8A","CD8B", "CD4"))
...
#}
library(SCENIC)
scenicOptions <- initializeScenic(org= "hgnc" , dbDir="E:/work/Tcell/cisTarget_databases" , nCores=5) 
